const StarRating = () => {
    return ( <svg className="w-28" role="img" ariaLabelledby="starRating" viewBox="0 0 251 46" xmlns="http://www.w3.org/2000/svg" >
    <title id="starRating" lang="en">3.7 out of five star rating on Trustpilot</title>
    <g className="tp-star">
        <path className="tp-star__canvas" fill="#ffce00" d="M0 46.330002h46.375586V0H0z"></path>
    ...
    <g className="tp-star">
        <path className="tp-star__canvas" fill="#ffce00" d="M51.24816 46.330002h46.375587V0H51.248161z"></path>
        <path className="tp-star__canvas--half" fill="#ffce00" d="M51.24816 46.330002h23.187793V0H51.248161z"></path>
    ...
    <g className="tp-star">
        <path className="tp-star__canvas" fill="#ffce00" d="M102.532209 46.330002h46.375586V0h-46.375586z"></path>
        <path className="tp-star__canvas--half" fill="#ffce00" d="M102.532209 46.330002h23.187793V0h-23.187793z"></path>
    ...
    <g className="tp-star">
        ...
        <path className="tp-star__canvas--half" fill="#ffce00" d="M153.815458 46.330002h23.187793V0h-23.187793z"></path>
