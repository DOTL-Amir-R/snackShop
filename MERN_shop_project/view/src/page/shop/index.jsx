    ...
    return (
        <main className='bg-neutral-50'>
            ...
            <div className='flex container pt-8 gap-4'>
                <div className='grow'>
                <button className='text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-3xl text-sm px-5 py-2.5 text-center'>categoties</button>
                </div>
                <button className='text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-3xl text-sm px-5 py-2.5 text-center'>sort by</button>
                <button className='text-white text-start bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-3xl text-sm px-5 py-2.5 '>filter</button>
            </div>
