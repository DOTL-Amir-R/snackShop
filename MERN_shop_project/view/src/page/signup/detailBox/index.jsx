        ...
        padding: '0rem 3rem 0 1rem'}} className="flex flex-col width-29-percent">
            <div className="flex  p-3">
                ...
                <div className="flex flex-col ml-3 justify-between">
                    <div className="text-xs color-gray-9b9b9b font-medium">
                        YOU'VE SELECTED
                    </div>
            ...
            <div className="mt-6 flex flex-col p-4 border-1-color-ddd rounded-2xl">
                <div className="flex justify-center items-center p-3 mx-11 mb-11 background-color-light-green-ceeddc border-radius-10">
                    ...
                    <div className="text-sm font-medium color-green-0aa550 ml-2">
                        1st box half price (£2.49)
                    </div>
                </div>
                <div className="flex justify-between">
                    <div className="text-lg font-normal">Subtotal</div>
                    <div className="flex ">
                        <div className="color-gray-7a7a7a mr-2 text-lg">
                            £4.99
                        </div>
                        <div className="text-lg font-semibold color-orange-fa701f">
                            £2.49
                        </div>
                    </div>
                </div>
            ...
            <div className="flex self-center mt-4 mb-6 text-sm">
                The price of your next box is £4.99
            </div>
            <div className='flex '>
